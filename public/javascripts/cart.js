...
const cargarTabla = (carrito) => {
    ...
    carrito.forEach(producto => {
        let item = `
            ...
            <a class="text-danger h5" onClick="removeItem(event,${producto.products_id})"><i class="fas fa-minus-square"></i></a>
            <span class="h5">${producto.cantidad}<span>
            <a class="text-success h5" onClick="agregarItem(event,${producto.products_id})"><i class="fas fa-plus-square"></i></a>
            </td>
